...
GO
--------------------------------------------------------------------------------
--	TheVendor profile groups and keys management procedures
--------------------------------------------------------------------------------
...
GO
--------------------------------------------------------------------------------
--	TheVendor WARNINGDEFAULTS management procedures
--------------------------------------------------------------------------------
...
BEGIN
	/* ------------------------------------------------------------------------------
	This procedure maintains the split of TheVendor's Audit Trail table TAUDITTRAIL 
	into two tables:
	...
	---
	  ...
	  This procedure should be run outside office hours, as it can block TheVendor users
	...
	-- FAIL if TAUDITTRAIL_HISTORY does not exist already: TheVendor uses a single audit trail table (no split)
	...
	-- In the final version, we want to read the # of months from a TheVendor system profile setting.
	declare @MonthsToKeep bigint
	set @MonthsToKeep = 1 /* TheCompany setting, standard is 3 months */
	...
	Update statistics TAUDITTRAIL /* TheCompany addition */
	Update statistics TAUDITTRAIL_HISTORY /* TheCompany addition */
